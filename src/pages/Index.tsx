                ...
                >
                  ...
                  <SheetDescription asChild>
                    <span className="sr-only">
                      Navigasjonsmeny for mobil. Lukk menyen for å gå tilbake
                      til innholdet.
                    </span>
                  </SheetDescription>
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Frontend & Mobilutvikling Student Og Fremtidig Full-Stack
                Utvikler
              </p>
              <p></p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                  ...
                  jeg bygger praktiske ferdigheter gjennom personlige
                  prosjekter.
                </p>
                <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                  Målet mitt er å bli med i et dynamisk team hvor jeg kan bidra
                  til meningsfulle prosjekter, samtidig som jeg fortsetter å
                  lære og utvikle meg som utvikler. Jeg er spesielt interessert
                  i webutvikling, brukeropplevelsesdesign og nye teknologier.
                  Selv om jeg er en frontend student så har jeg som mål å bli en
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                      ...
                      "Entry level" der jeg kan bidra til innovative prosjekter
                      og utvikle meg som utvikler. La oss diskutere hvordan jeg
                      kan tilføre verdi til teamet ditt!
                    </p>
                  </div>
